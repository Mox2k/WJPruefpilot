...
class PDFGeneratorTemp:
    ...
    def __init__(self):
        ...
        self.data_to_append = {}  # <- Hier hinzugefügt
    ...
    def add_company_and_inspector_data(self):
        ...
        try:
            ...
            with Image.open(logo_bild) as logo:
                ...
                base_width = 1600  # Sie können diesen Wert anpassen
    ...
    def add_tempjustage_data(self, temp_data):
        try:
            ...
            # #geändert: Diagramm erstellen mit angepasster Größe
    ...
    def generate_calibration_number(self):
        ...
        waage_id = self.data_to_append.get('waage_data', {}).get('WJ-Nummer', '')  # #neu hinzugefügt
    ...
    def generate_pdf(self, filename="report.pdf"):
        ...
        <head>
            ...
            <style>
                ...
                .signature {{ max-height: 150px; width: 120px; height: auto; }}
